...
pygame.display.set_caption("A* pathfindin Algorithm")
...
def draw_grid(win, rows, width):
	...
	for i in range(0, width, cell_size):
		pygame.draw.line(win, (200, 200, 200), (0, i), (width, i))
		pygame.draw.line(win, (200, 200, 200), (i, 0), (i, width))
